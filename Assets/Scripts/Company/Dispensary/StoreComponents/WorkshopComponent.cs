...
public class WorkshopComponent : MonoBehaviour
{
    ...
    public WorkshopComponent_s MakeSerializable()
    {
        ...
        WorkshopComponent_s toReturn = new WorkshopComponent_s(gameObject.transform.position, gameObject.transform.eulerAngles.y, serializableGrids, serializableWindows, serializableStoreObjects);
        return toReturn;
	}
