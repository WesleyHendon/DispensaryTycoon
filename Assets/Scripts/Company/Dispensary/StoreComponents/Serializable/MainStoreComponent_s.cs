...
[System.Serializable]
public class MainStoreComponent_s
{
    // component info
    ...
    public MainStoreComponent_s(Vector3 componentPos, float componentYRot, List<Grid_s> grids, List<WindowSection_s> windowSections, List<StoreObject_s> storeObjects_)
    {
