...
[System.Serializable]
public class GrowroomComponent_s
{
    // component info
    public int index;
    ...
    public GrowroomComponent_s(int index_, Vector3 componentPos, float componentYRot, List<Grid_s> grids, List<StoreObject_s> storeObjects_, List<WindowSection_s> windowSections)
    {
        index = index_;
