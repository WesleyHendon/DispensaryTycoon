...
[Serializable]
public class SmokeLoungeComponent : MonoBehaviour
{
    ...
    public SmokeLoungeComponent_s MakeSerializable()
    {
        ...
        SmokeLoungeComponent_s toReturn = new SmokeLoungeComponent_s(gameObject.transform.position, gameObject.transform.eulerAngles.y, serializableGrids, serializableWindows, serializableStoreObjects);
        return toReturn;
	}
