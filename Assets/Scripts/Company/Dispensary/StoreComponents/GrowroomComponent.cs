...
[Serializable]
public class GrowroomComponent : MonoBehaviour
{
    ...
    public GrowroomComponent_s MakeSerializable()
    {
        ...
        GrowroomComponent_s toReturn = new GrowroomComponent_s(index, gameObject.transform.position, gameObject.transform.eulerAngles.y, serializableGrids, serializableStoreObjects, serializableWindows);
        return toReturn;
	}

	public string cToString() // Component to string
	{
		return "Growroom" + index;
    }
