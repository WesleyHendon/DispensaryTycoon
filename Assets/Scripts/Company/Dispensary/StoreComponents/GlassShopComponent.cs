...
[Serializable]
public class GlassShopComponent : MonoBehaviour
{
	...
	public GlassShopComponent_s MakeSerializable()
	{
        ...
        GlassShopComponent_s toReturn = new GlassShopComponent_s(gameObject.transform.position, gameObject.transform.eulerAngles.y, serializableGrids, serializableStoreObjects, serializableWindows);
        return toReturn;
	}
