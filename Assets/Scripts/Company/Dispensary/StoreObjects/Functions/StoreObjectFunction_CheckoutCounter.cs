...
[System.Serializable]
public class StoreObjectFunction_CheckoutCounter : MonoBehaviour
{
    ...
    public StoreObjectFunction_CheckoutCounter_s MakeSerializable()
    {
        return new StoreObjectFunction_CheckoutCounter_s();
    }
